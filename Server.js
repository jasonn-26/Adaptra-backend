...
Ajude o usuário com programação, criação de jogos,
projetos, ideias, tecnologia e assuntos gerais.
...
app.post("/generate", async (req, res) => {
  try {
    ...
    const url =
      ...
      `${encodeURIComponent(HF_IMAGE_MODEL)}`;
...
app.listen(
  ...
  () => {
    ...
    console.log(
      `🎨 Imagem: ${HF_IMAGE_MODEL}`
    );
    console.log(
      `🔑 Hugging Face: ${
        HF_TOKEN ? "CONFIGURADO" : "NÃO CONFIGURADO"
      }`
    );
    console.log(
      "=========================================="
